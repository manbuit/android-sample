...
public class FavoriteFragment extends ListFragment implements SwipeRefreshLayout.OnRefreshListener, LoadData {
//public class AccountFragment extends SwipeRefreshListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View accountLayout = inflater.inflate(R.layout.fragment_favorite, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        accountListView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView arg0, int scrollState) {
                ...
                if (scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE
                    ...
                    // TODO 这里需要"加载更多"的代码
                    loadData(adapter.getCount(), PAGE_SIZE, ((MainActivity) getActivity()).queryConds.get(FavoriteFragment.class.getName()), loadDataHandler);
                }
            }
        ...
        loadData(0, PAGE_SIZE, ((MainActivity) getActivity()).queryConds.get(FavoriteFragment.class.getName()), loadDataHandler);
