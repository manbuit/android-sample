...
public class StdDBFragment extends ListFragment implements SwipeRefreshLayout.OnRefreshListener, LoadData {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View accountLayout = inflater.inflate(R.layout.fragment_std_db, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
            ...
            public void onScrollStateChanged(AbsListView arg0, int scrollState) {
                ...
                if (scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE
                    ...
                    loadData(
                            adapter.getCount(),
                            PAGE_SIZE,
                            ((MainActivity) getActivity()).queryConds.get(StdDBFragment.class.getName()),
                            loadDataHandler
                    );
                }
            }
        ...
        loadData(0, PAGE_SIZE, ((MainActivity) getActivity()).queryConds.get(StdDBFragment.class.getName()), loadDataHandler);
